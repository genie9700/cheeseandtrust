<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-24 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
       <ul class="space-y-4 font-medium">
          <li>
             <a href="{{ route('admin.dashboard') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ (request()->is('admin.dashboard')) ? 'text-white bg-gray-100' : '' }}">
                ...
                <span class="ml-3  {{ (request()->is('admin.dashboard')) ? 'text-[#0891B2]' : '' }}">Dashboard</span>
             </a>
          </li>
           <li>
             <a href="{{ route('admin.user.index') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ (request()->is('admin/user*')) ? 'text-white bg-gray-100' : '' }}">
          ...
          <li>
             <a href="{{ route('admin.deposit.index') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ (request()->is('admin/deposited*')) ? 'text-white bg-gray-100' : '' }}">
                <svg class="w-5 h-5 text-gray-800 dark:text-white {{ (request()->is('admin/deposited*')) ? 'text-[#0891b2]' : '' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
          ...
          <li>
             <a href="{{ route('admin.withdraw') }}" wire:navigate class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ (request()->is('admin/withdrawal')) ? 'text-white bg-gray-100' : '' }}">
                <svg class="w-5 h-5 text-gray-800 dark:text-white {{ (request()->is('admin/withdrawal')) ? 'text-[#0891b2]' : '' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
