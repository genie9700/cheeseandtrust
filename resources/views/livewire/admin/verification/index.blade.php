...
<div>
    <p class="text-text-[#0891b2] dark:text-white font-semibold text-2xl my-8">verifications</p>
                    ...
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @elseif($item->status == 0)
                                        <span
                                            class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded  border border-yellow-300">Pending</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('admin.verify.edit', $item->id) }}" wire:navigate
                                        class="font-medium text-blue-600  hover:underline mr-2">View</a>
